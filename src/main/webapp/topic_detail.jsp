        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <li style="float: right">
                    <img src="${loginUser.img}" class="img-circle" width="25px" height="25px" style="margin-top: 10px"
                         alt="">
                </li>
                <li style="float: right"><a href="${pageContext.request.contextPath}/publish.jsp">发布主题</a></li>
                <li style="float: right">
                    <a href="${pageContext.request.contextPath}/reply.jsp?topic_id=${param.topic_id}">盖楼回复</a></li>
            </c:otherwise>
        </c:choose>
    </ul>
